...
<div class="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-10 relative z-10">
    ...
    <div class="mt-6 sm:mt-0 relative group w-full sm:w-auto sm:inline-block hover:scale-[1.02] transition-transform duration-300">
        ...
        <a href="{{ route('tasks.create') }}" class="relative w-full flex items-center justify-center gap-3 bg-gradient-to-r from-[#1d61bd] to-[#0ea0d8] text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-xl">
