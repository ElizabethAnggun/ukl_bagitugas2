...
<div class="bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-lg shadow-blue-900/5 border border-white/80 relative z-10 overflow-hidden mb-8">
    <div class="p-8 border-b border-gray-100/50 flex items-center justify-between bg-white/50">
        <h2 class="text-xl font-bold text-gray-800 flex items-center">
            <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-[#1d61bd] to-[#0ea0d8] flex items-center justify-center text-white mr-4 shadow-md">
            ...
            <div class="relative w-full max-w-2xl mx-auto my-8 bg-gray-50/50 rounded-[3rem] p-16 text-center border border-dashed border-gray-200 overflow-hidden">
                <div class="relative z-10">
                    <div class="w-32 h-32 mx-auto mb-6 relative">
                        <div class="absolute inset-0 bg-[#0ea0d8]/20 rounded-full blur-2xl animate-pulse"></div>
...
<div class="mt-8 bg-gradient-to-r from-indigo-50 to-blue-50/50 backdrop-blur-sm rounded-[2rem] p-8 border border-indigo-100/50 relative z-10 flex flex-col md:flex-row items-start hover:shadow-lg transition-shadow duration-300">
    ...
    <div class="w-14 h-14 bg-white rounded-2xl flex items-center justify-center mr-6 flex-shrink-0 shadow-md mb-4 md:mb-0">
        <i class="fas fa-info-circle text-3xl bg-gradient-to-br from-[#1d61bd] to-[#0ea0d8] bg-clip-text text-transparent"></i>
    </div>
    <div>
        <h3 class="text-lg font-extrabold text-[#1d61bd] mb-2">Pusat Rekam Jejak Sistem</h3>
        <p class="text-blue-900/80 font-medium leading-relaxed">
...
<div class="fixed bottom-0 left-8 z-40 hidden lg:block group">
    <div class="absolute -top-14 left-1/2 -translate-x-1/2 bg-white px-5 py-3 rounded-2xl shadow-[0_5px_15px_rgba(0,0,0,0.1)] border border-[#0ea0d8]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none w-max bounce-bubble">
        <p class="text-sm font-extrabold bg-gradient-to-br from-[#1d61bd] to-[#0ea0d8] bg-clip-text text-transparent">Semoga banyak yang hijau (selesai) ya! 🐨</p>
        <div class="absolute -bottom-2 left-1/2 -translate-x-1/2 w-4 h-4 bg-white transform rotate-45 border-b border-r border-[#0ea0d8]/20"></div>
    </div>
