...
<div class="mb-8">
    ...
    <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Edit Proyek</h1>
    <p class="text-gray-600 mt-1">Perbarui informasi proyek {{ $project->name }}</p>
</div>
...
<div class="bg-white rounded-xl shadow-sm max-w-2xl">
    <div class="p-6 border-b">
        <h2 class="text-lg font-bold text-gray-800">
            <i class="fas fa-edit text-yellow-500 mr-2"></i>Edit Informasi Proyek
        </h2>
    </div>
    ...
    <form action="{{ route('projects.update', $project) }}" method="POST" class="p-6">
        ...
        <div class="mb-6">
            ...
            <textarea name="description" 
                      ...
                      placeholder="Jelaskan tentang proyek ini...">{{ old('description', $project->description) }}</textarea>
            @error('description')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
